...
module.exports = class CheckRole extends Command {
    constructor(client) {
        super(client, {
            ...
            description: 'Gets the permissions of a role in the target channel.',
            guildOnly: true,
            args: [
                {
                    key: 'role',
    ...
    async run(message, { role, channel }) {
        ...
        const voicePermissions = [
            'VIEW_CHANNEL', 'CONNECT', 'SPEAK', 'STREAM', 'MUTE_MEMBERS', 'DEAFEN_MEMBERS', 'MOVE_MEMBERS', 'SPEAK', 'PRIORITY_SPEAKER'
        ]
