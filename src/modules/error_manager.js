	...
	MarkManager.queue(async function() {
		if (app.isInitialized()) {
			try {
				...
				if (ErrorTicket.error) embed.addField('Error Message', ErrorTicket.error);
				embed.addField('EPM', epm, true);
				embed.addField('TH', threshold_reached ? 'True' : 'False', true);
				embed.addField('THC', threshold_hit_count, true);
			...
			console.error('ErrorManager: App is not initialized');
		}
